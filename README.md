...
|<br />Write Colab notebook for training and evaluating <br>ESRGAN using TF-GAN|[Link](esrgan/colab_notebook)|:heavy_check_mark:|[#48](https://github.com/tensorflow/gan/pull/48)|
|<br />Add TPU support for ESRGAN<br /><img width=1/>|[Link](esrgan/colab_notebook)|:heavy_check_mark:|[#48](https://github.com/tensorflow/gan/pull/48)|
