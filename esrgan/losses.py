...
def RealitivisticAverageLoss(non_trans_disc, type_="G"):
  """ Takes in the output of discriminator network to predict if the
      generated image is more/less realistic than the real/fake data,
      rather than simply calculating if the output is real/fake.
  ...
  return loss_G if type_ == "G" else loss_D
